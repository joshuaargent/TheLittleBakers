        ...
        <nav className="container">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden items-center gap-1 md:flex">
              ...
              >
                {theme === 'dark' ? (
                  <Sun className="h-5 w-5 text-[var(--color-cream)]" />
                ) : (
                  <Moon className="h-5 w-5 text-[var(--color-cream)]" />
                )}
              </Button>
            </div>
              ...
              <div className="mt-8 border-t border-[var(--color-border)] pt-8">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <button
                      ...
                      className="inline-flex items-center justify-center gap-2 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-card)] px-4 py-2 text-sm font-medium text-[var(--color-text)] transition-all duration-200 hover:bg-[var(--color-bg-secondary)]"
                    >
                      {theme === 'dark' ? (
                        <>
